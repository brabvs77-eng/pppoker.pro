...
function iframeHandler(target){var isVimeo=target&&(target.indexOf("https://player.vimeo.com/")===0);var addHtml="";if(isVimeo==true)
addHtml="allow=\"autoplay; fullscreen; picture-in-picture\"";var htmlFrame='<div class="lity-iframe-container"><iframe frameborder="0" allowfullscreen '+addHtml+' src="'+target+'"/></div>';return(htmlFrame);}
