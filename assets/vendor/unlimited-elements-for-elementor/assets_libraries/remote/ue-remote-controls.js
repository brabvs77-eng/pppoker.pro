...
g_vars.options_api=optionsFromData;if(g_vars.trace_debug==true){if(g_vars.options_api)
trace(g_vars.options_api);else
g_vars.options_api={};g_vars.options_api.trace_debug=true;}
